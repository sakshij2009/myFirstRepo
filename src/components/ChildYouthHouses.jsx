...
const PROGRAM_TITLE = "Child & Youth – Houses";
const PROGRAM_SUB   = "Manage houses under Child & Youth Program Cycle";
const ADD_PARAM     = "child-youth";
...
const DEMO_HOUSES = [
  {
    id: "__demo_1",
    houseName: "Willow Creek House",
    address: "55 Willow Cres, Red Deer AB",
    maxCapacity: 6,
    activeClients: 5,
    staffCount: 6,
    compliancePct: 97,
  ...
  {
    id: "__demo_2",
    houseName: "Pine Valley Youth Home",
    address: "90 Pine St, Red Deer AB",
    maxCapacity: 8,
    activeClients: 6,
    staffCount: 5,
    compliancePct: 91,
                      ...
                      <div className="flex items-center justify-end gap-1.5">
                        <button
                          onClick={() => navigate(`/admin-dashboard/house/${house.id}`, {
                            state: { house, programLabel: PROGRAM_LABEL, programPath: `/admin-dashboard/child-youth-houses` }
                          })}
