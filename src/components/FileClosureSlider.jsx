...
import { collection, addDoc, updateDoc, doc, serverTimestamp, getDoc, getDocs } from "firebase/firestore";
...
const FileClosureSlider = ({ isOpen, onClose, selectedClient }) => {
    ...
    const [exitInterviewConducted, setExitInterviewConducted] = useState(null);
    const [clientFeedbackCollected, setClientFeedbackCollected] = useState(null);
