...
const AddUserForm = ({ mode = "add", user }) => {
  ...
  const validationSchema = Yup.object({
    ...
    phone: Yup.string().required("Phone required").matches(/^\d{3}-?\d{3}-?\d{4}$/, "Must be 10 digits"),
    ...
    emergencyContactPhone: Yup.string().required("Phone required").matches(/^\d{3}-?\d{3}-?\d{4}$/, "Must be 10 digits"),
    ...
    referencePhone: Yup.string().required("Phone required").matches(/^\d{3}-?\d{3}-?\d{4}$/, "Must be 10 digits"),
