...
const PROGRAM_TYPE  = "pdd";
const PROGRAM_LABEL = "Person with Developmental Disability (PDD)";
const PROGRAM_TITLE = "PDD – Houses";
const PROGRAM_SUB   = "Manage houses under Person with Developmental Disability (PDD) Program";
const ADD_PARAM     = "pdd";
...
const DEMO_HOUSES = [
  {
    id: "__demo_1",
    houseName: "Cedar Ridge Home",
    address: "789 Cedar Blvd, Edmonton AB",
    maxCapacity: 5,
    activeClients: 4,
    staffCount: 5,
    compliancePct: 94,
  ...
  {
    id: "__demo_2",
    houseName: "Harmony Place",
    address: "321 Birch Lane, Edmonton AB",
    maxCapacity: 3,
    activeClients: 3,
    staffCount: 4,
    compliancePct: 100,
                      ...
                      <div className="flex items-center justify-end gap-1.5">
                        <button
                          onClick={() => navigate(`/admin-dashboard/house/${house.id}`, {
                            state: { house, programLabel: PROGRAM_LABEL, programPath: `/admin-dashboard/pdd-houses` }
                          })}
