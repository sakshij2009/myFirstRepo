    ...
    const loadData = async () => {
      try {
        ...
        if (shiftId) {
          ...
          if (shiftSnap.exists() && shiftSnap.data().followThroughEvent) {
            const saved = shiftSnap.data().followThroughEvent;
        ...
        console.warn("Failed to load follow through data:", err);
      }
    };
    loadData();
  }, [shiftId, draftKey]);
            ...
            <div className="flex flex-col gap-[10px]">
              ...
              <div className="">
                <Field
                  ...
                  className={`w-full border border-light-gray rounded p-2 h-40 focus:outline-none placeholder:text-[#72787E] placeholder:text-[14px] ${touched.followThroughNote && errors.followThroughNote
                    ? "border-red-500"
                    : "border-gray-300"
                    }`}
                />
