// ✅ Create: src/components/FollowThroughModal.jsx
// - Matches your screenshot style (green header + green submission box)
// - Includes SafeArea top padding fix like Medical/Noteworthy
...
export default function FollowThroughModal({ visible, onClose, shift, onSubmit }) {
  ...
  const validate = () => {
    ...
    if (!form.followThroughText?.trim()) return "Follow Through is required";
    return null;
  };
        ...
        >
          ...
          <View style={styles.topCard}>
            <View style={styles.topIcon}>
              <MaterialCommunityIcons name="repeat" size={18} color="#16A34A" />
            </View>

            <View style={{ flex: 1 }}>
              <Text style={styles.topTitle}>Follow Through</Text>
          ...
          <Label label="Follow Up Date & Time" />
          <TextInput
            value={form.followUpDateTime}
            onChangeText={(t) => set("followUpDateTime", t)}
            placeholder="Please enter the phone number"
            style={styles.input}
          />
          ...
          {/* FOLLOW THROUGH */}
          <Text style={styles.sectionTitle}>
            Follow Through<Text style={{ color: "#DC2626" }}> *</Text>
          </Text>

          <TextInput
            value={form.followThroughText}
            onChangeText={(t) => set("followThroughText", t)}
            placeholder="Follow through for any medications"
            multiline
          ...
          {/* SUBMISSION CARD (green like your screenshot) */}
...
const styles = {
  ...
  submitTitle: { fontSize: 12.5, fontWeight: "900", color: "#16A34A", flex: 1 },
  submitText: { marginTop: 8, fontSize: 11.5, lineHeight: 16, color: "#16A34A", fontWeight: "600" },
